...
void arregloAnimalesHaciaArchivo(stAnimal a[], int v, char nombreArchivo[], int cond)
{
...
float promiedosArreglo(stAnimal a[], int v)
{

    int suma = sumatoriaPoblacion(a,v,0);

    float promedio = (float) suma / v;
...
/*
float promiedosArreglo(stAnimal a[], int v){
    return (float) sumatoriaPoblacion(a,v,0) / v;
} */
...
int cantidadAnimalesArregloConCondicion(stAnimal a[], int v, float promedio)
{
...
int cantidadAnimalesArregloConCondicionRecursiva(stAnimal a[], int v, int i, float promedio)
{
    ...
    else
    {
        ...
        if( a[i].poblacion > promedio )
        {
            cant = 1 + cantidadAnimalesArregloConCondicionRecursiva(a,v, i+1,promedio);
        }
        else
        {
            cant = 0 + cantidadAnimalesArregloConCondicionRecursiva(a,v,i+1,promedio);
        }
...
float porcentajeCantAnimalesMayorPoblacionPromedio(stAnimal a[], int v)
{

    float promedio = promiedosArreglo(a,v);
    int cantValida = cantidadAnimalesArregloConCondicion(a,v,promedio);

    float porcentaje = (float) cantValida * 100 / v;
